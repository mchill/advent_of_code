        ...
        for sugar in 0..100
            for sprinkles in 0..(100 - sugar)
                for candy in 0..(100 - sugar - sprinkles)
                    ...
                    calories = (
                        sugar * ingredients['sugar'][:calories] +
                        sprinkles * ingredients['sprinkles'][:calories] +
                        candy * ingredients['candy'][:calories] +
                        chocolate * ingredients['chocolate'][:calories]
                    )
